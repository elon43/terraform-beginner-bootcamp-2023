...
# by setting a global variable.  You would never use a global
# variable in a production server.
$home = {}
...
class Home
  ...
  # that provides validations.

  # The production Terratowns server is rails and uses very similar 
  # and in most cases identical validation
...
# We are extending a class from Sinatra::Base to turn this generic class
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    # Check if the Authoriation header exists?
    ...
    # Was there a user_uuid in the payload body?
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # puts will print tothe terminal similar to a print or console.log
    puts "# create - POST /api/homes"

    # A begin/recue is a try/catch, if an error occurs, return it.
    begin
      # Sinatra does not automatically parse json body's as params like rails, so
    ...
    # Printing the variables out to console to make it easier to see or debug what
    # we have inputed into this endpoint
    puts "name #{name}"
  ...
  # UPDATE
  # Very similiar to CREATE action
...
# This is what wil run the server
